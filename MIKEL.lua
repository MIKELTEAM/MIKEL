...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MIKEL.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("MIK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S MIKEL -X kill
screen -S MIKEL ./MIKEL
done
]])  
file:close() 
...
local MIKEL_Msg = ''  
if msgs < 100 then 
MIKEL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MIKEL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MIKEL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MIKEL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MIKEL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MIKEL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MIKEL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MIKEL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MIKEL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MIKEL_Msg = 'اقوى متفاعل' 
...
function plugin_MIKEL(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MIKEL and msg then
pre_msg = plugin.MIKEL(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function THEOMIKEL(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MIKEL_Msg) 
return false  
end 
if text then    
...
file = download_to_file(url1,'MIKEL.webp')
print('TIMESSSS')
local MIKEL = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. MIKEL .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'MIKEL.webp' .. '"'
io.popen(curl)
end
...
send(msg.chat_id_, msg.id_,'〖•»اصدار سورس مايكل \n📟| الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'〖•»عدد المجموعات الان » { '..#group..' }'..MIKELk..''..MIKEL..'\n*-الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n〖•»العضو » ['..result.title_..'](t.me/'..(username or 'NIII55')..')'
...
if sadam1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'〖•»العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NIII55')..') \n - '..sadam1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/NIII55)}\n〖•»["..sadam_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "-عذرا يا » {["..data.first_name_.."](t.me/NIII55)}\n〖•»الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
'☬┋Welcome To Source MIKEL . 
  『───────···───────』
𓅛↳  [𝙈𝙄𝙆𝙀𝙇 𝙏𝙄𝙈𝙀](http://t.me/NIII55)
  『───────···───────』
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'〖•»بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NIII55')..') \n〖•»تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'〖•»بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NIII55')..') \n〖•»تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == 'تاك للاساسين' or text == ("منشن الاساسين") and Sudo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n〖•»لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NIII55')..')'
status  = '\n〖•»تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n〖•»العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'〖•»بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NIII55')..') \n〖•»تـم قفـل التفليش ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n〖•»العضو » ['..result.title_..'](t.me/'..(text1[3] or 'NIII55')..')'..'\n〖•»تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..MIKEL_Msg[math.random(#MIKEL_Msg)]..']') 
return false
end
...
local list = database:smembers(bot_id..'List:BasicConstructor'..msg.chat_id_..'')
for k,v in pairs(list) do
database:del(bot_id.."Add:Rd:BasicConstructor:Gif"..v..msg.chat_id_)   
database:del(bot_id.."Add:Rd:BasicConstructor:Vico"..v..msg.chat_id_)   
database:del(bot_id.."Add:Rd:BasicConstructor:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Add:Rd:BasicConstructor:Text"..v..msg.chat_id_)   
database:del(bot_id.."Add:Rd:BasicConstructor:Photo"..v..msg.chat_id_)
database:del(bot_id.."Add:Rd:BasicConstructor:Video"..v..msg.chat_id_)
database:del(bot_id.."Add:Rd:BasicConstructor:File"..v..msg.chat_id_)
database:del(bot_id.."Add:Rd:BasicConstructor:Audio"..v..msg.chat_id_)
database:del(bot_id..'List:BasicConstructor'..msg.chat_id_)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'NIII55')..')'
local iduser = result.sender_user_id_
...
MIKEL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MIKEL)
...
--------------------------------------------------------------------------------------------------------------
THEOMIKEL(data.message_,data)
plugin_MIKEL(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local MIKELAbot = database:get(bot_id.."MIKEL1:Add:Filter:Rp2"..text..result.chat_id_)   
if MIKELAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"〖•»العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n〖•»["..MIKELAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MIKEL1_Msg = database:get(bot_id.."MIKEL1:Add:Filter:Rp2"..text..result.chat_id_)   
if MIKEL1_Msg then    
send(msg.chat_id_, msg.id_,"〖•»"..MIKEL1_Msg)
